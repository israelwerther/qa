...
# Workflow: Criar Caderno de Teste para QA (`/qa-create-exam`)
...
**Input**: O texto passado após `/qa-create-exam` descreve o caderno desejado.  
*Exemplos:*
- `/qa-create-exam 10 questões objetivas com alternativas embaralhadas`
- `/qa-create-exam 5 objetivas, 2 discursivas e 1 redação para teste híbrido`
- `/qa-create-exam Simulado PAS com 15 objetivas e 3 discursivas`
- `/qa-create-exam` (sem texto — o assistente infere um padrão equilibrado ou pergunta ao usuário)
